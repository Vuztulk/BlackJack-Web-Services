...
SOAP_SOURCE_STAMP("@(#) soapClient.c ver 2.8.131 2023-11-07 17:05:57 GMT")
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_blackJackns__getStatus(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int id_partida, struct tBlock *status)
{	if (soap_send_blackJackns__getStatus(soap, soap_endpoint, soap_action, playerName, id_partida) || soap_recv_blackJackns__getStatus(soap, status))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send_blackJackns__getStatus(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int id_partida)
{	struct blackJackns__getStatus soap_tmp_blackJackns__getStatus;
	if (soap_endpoint == NULL)
		soap_endpoint = "http//localhost:10000";
	soap_tmp_blackJackns__getStatus.playerName = playerName;
	soap_tmp_blackJackns__getStatus.id_partida = id_partida;
	soap_begin(soap);
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_call_blackJackns__playerMove(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int id_partida, unsigned int playerMove, struct tBlock *status)
{	if (soap_send_blackJackns__playerMove(soap, soap_endpoint, soap_action, playerName, id_partida, playerMove) || soap_recv_blackJackns__playerMove(soap, status))
		return soap->error;
	return SOAP_OK;
}

SOAP_FMAC5 int SOAP_FMAC6 soap_send_blackJackns__playerMove(struct soap *soap, const char *soap_endpoint, const char *soap_action, struct tMessage playerName, int id_partida, unsigned int playerMove)
{	struct blackJackns__playerMove soap_tmp_blackJackns__playerMove;
	if (soap_endpoint == NULL)
		soap_endpoint = "http//localhost:10000";
	soap_tmp_blackJackns__playerMove.playerName = playerName;
	soap_tmp_blackJackns__playerMove.id_partida = id_partida;
