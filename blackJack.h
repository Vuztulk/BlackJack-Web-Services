...
int blackJackns__getStatus 		(blackJackns__tMessage playerName, int id_partida, blackJackns__tBlock *status);
int blackJackns__playerMove 	(blackJackns__tMessage playerName, int id_partida,unsigned int playerMove, blackJackns__tBlock *status);
