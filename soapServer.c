...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.131 2023-11-07 17:05:57 GMT")
...
{	struct blackJackns__getStatus soap_tmp_blackJackns__getStatus;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__getStatus(soap, soap_tmp_blackJackns__getStatus.playerName, soap_tmp_blackJackns__getStatus.id_partida, soap_tmp_blackJackns__getStatusResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
...
{	struct blackJackns__playerMove soap_tmp_blackJackns__playerMove;
	...
	if (soap_body_end_in(soap)
	 ...
	 || soap_end_recv(soap))
		return soap->error;
	soap->error = blackJackns__playerMove(soap, soap_tmp_blackJackns__playerMove.playerName, soap_tmp_blackJackns__playerMove.id_partida, soap_tmp_blackJackns__playerMove.playerMove, soap_tmp_blackJackns__playerMoveResponse.status);
	if (soap->error)
		return soap->error;
	soap->encodingStyle = ""; /* use SOAP encoding style */
	soap_serializeheader(soap);
