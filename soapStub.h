...
struct blackJackns__getStatus {
        /** Required element 'playerName' of XML schema type 'blackJackns:tMessage' */
        struct tMessage playerName;
        /** Required element 'id-partida' of XML schema type 'xsd:int' */
        int id_partida;
};
#endif
...
\******************************************************************************/
    ...
    SOAP_FMAC5 int SOAP_FMAC6 blackJackns__getStatus(struct soap*, struct tMessage playerName, int id_partida, struct tBlock *status);
    /** Web service operation 'blackJackns__playerMove' implementation, should return SOAP_OK or error code */
    SOAP_FMAC5 int SOAP_FMAC6 blackJackns__playerMove(struct soap*, struct tMessage playerName, int id_partida, unsigned int playerMove, struct tBlock *status);
